        ...
        <div className="flex h-12 items-center justify-between">
          ...
          <div className="">
            <button
              ...
              className="inline-flex items-center gap-2 justify-center whitespace-nowrap text-sm font-medium color ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 hover:text-accent-foreground h-10 w-10 rounded-md hover:bg-secondary-300/10"
